 ...
 * Time: 4:48:06 PM
 */
@ManagedBean(name = "ParcelControllerBean")
@SessionScoped
public class ParcelController
    extends OPSController
{
  static final long serialVersionUID = 42L;
  private static final Logger logger = Logger.getLogger(ParcelController.class.getName());
...
//  private ShipmentController shipmentController;
  ...
  private void clearValues()
  {
    ...
    parcelEvent.setDate(Calendar.getInstance());
  }
  ...
  public void parcelIdActionListener(ActionEvent event)
  {
    logger.info("parcelIdActionListener");
  }
...
//  public void setShipmentController(ShipmentController shipmentController)
//  {
