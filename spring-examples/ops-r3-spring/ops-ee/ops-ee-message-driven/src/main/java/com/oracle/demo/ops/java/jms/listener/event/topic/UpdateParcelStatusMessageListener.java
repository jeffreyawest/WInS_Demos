...
import com.oracle.demo.event.handler.parcelstatus.UpdateParcelStatusEventHandler;
...
{
  public UpdateParcelStatusMessageListener()
  {
    eventHandler = new UpdateParcelStatusEventHandler();
  }
}
