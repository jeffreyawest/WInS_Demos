...
{
  var url = "/ops-rest-ws/rest-api/1/shipment/create.json";
...
{
  var url = "/ops-rest-ws/rest-api/1/shipment" + "/" + shipmentId + ".json";
...
{
  var url = "/ops-rest-ws/rest-api/1/parcel/log/" + parcelId + ".json";
...
{
  var url = "/ops-rest-ws/rest-api/1/parcel/log/list.json";
...
{
  var url = "/ops-rest-ws/rest-api/1/" + entityName + "/list.json";
