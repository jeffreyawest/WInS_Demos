...
public class MyMarshaller
{
  static
  {
    try
    {
      jaxbContext_services = JAXBContext.newInstance("com.oracle.demo.ops.domain");
  ...
  private static final String COM_ORACLE_DEMO_OPS_CONTEXT_PATH = "com.oracle.demo.ops.domain";
  private static JAXBContext jaxbContext_services;
