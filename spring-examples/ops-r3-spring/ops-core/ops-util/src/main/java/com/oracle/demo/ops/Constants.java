...
public class Constants
{
  ...
  public static final String EVENT_TOPIC_FOREIGN_JNDI = "foreign.com.oracle.demo.ops.jms.eventTopic";
  public static final String CONNECTION_FACTORY_FOREIGN_JNDI = "foreign.com.oracle.demo.ops.jms.cf";
