...
serverStart.setArguments('-Xms128m -Xmx256m')
...
for n in range(1, int(managed_server_count) + 1):
    ...
    serverStart.setArguments(
        '-Xms128m -Xmx256m -Dtangosol.coherence.ttl=0 -Dtangosol.coherence.distributed.localstorage=false -Dtangosol.coherence.session.localstorage=false -Dtangosol.coherence.cacheconfig=/coherence-cache-config.xml')
